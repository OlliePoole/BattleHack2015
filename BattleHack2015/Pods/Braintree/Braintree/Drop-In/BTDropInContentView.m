...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.applePayButton = [PKPaymentButton buttonWithType:PKPaymentButtonTypePlain style:PKPaymentButtonStyleWhite];
        ...
        // Full-Width Views
        for (UIView *view in @[self.paymentButton, self.applePayButton, self.selectedPaymentMethodView, self.summaryView, self.ctaControl, self.cardForm]) {
...
- (void)updateConstraints {
    ...
    NSDictionary *viewBindings = @{
                                   ...
                                   @"applePayButton" : self.applePayButton,
...
- (NSArray*) evaluateVisualFormat{
    ...
    if (self.state == BTDropInContentViewStateActivity) {
        ...
        if (self.hidePaymentButton){
            ...
            return @[[NSString stringWithFormat:@"V:|%@[paymentButton(==44)]-(18)-[applePayButton(==44)]-(18)-[cardFormSectionHeader]-(7)-[cardForm]%@|", summaryViewVisualFormat, ctaControlVisualFormat]];
        }
